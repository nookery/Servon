...
func (d *DpkgManager) IsInstalled(packageName string) bool {
...
// 如果软件包未安装，返回空字符串
func (d *DpkgManager) DpkgGetVersion(packageName string) string {
	cmd := exec.Command("dpkg", "-l", packageName)
	output, err := cmd.CombinedOutput()
	if err != nil {
		return ""
...
func (d *DpkgManager) ListPackages() ([]string, error) {
...
func (d *DpkgManager) GetArchitecture() (string, error) {
