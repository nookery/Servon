...
func (d *AstroDeployer) Deploy(projectName string, workDir string, targetDir string, logger *logger.LogUtil) error {
...
func (d *AstroDeployer) Build(workDir string, logger *logger.LogUtil) error {
